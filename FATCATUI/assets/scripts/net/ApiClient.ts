...
export class ApiClient {
    ...
    public static getPlayer(playerId: string): Promise<ApiEnvelope<PlayerDto>> {
        return this.get(`/api/player/me?playerId=${encodeURIComponent(playerId)}`);
    }
    ...
    public static fetchServerStatus(): Promise<ApiEnvelope<ServerStatusDto>> {
    ...
    public static getAchievements(playerId: string): Promise<ApiEnvelope<AchievementDto[]>> {
        return this.get(`/api/achievements?playerId=${encodeURIComponent(playerId)}`);
    }

    public static claimAchievement(playerId: string, achievementId: string): Promise<ApiEnvelope<AchievementClaimResponse>> {
        return this.post(`/api/achievements/${encodeURIComponent(achievementId)}/claim?playerId=${encodeURIComponent(playerId)}`, {});
    }

    public static getTasks(playerId: string): Promise<ApiEnvelope<TaskDto[]>> {
        return this.get(`/api/tasks?playerId=${encodeURIComponent(playerId)}`);
    }

    public static claimTask(playerId: string, taskId: string, request: TaskClaimRequest): Promise<ApiEnvelope<TaskClaimResponse>> {
        return this.post(`/api/tasks/${encodeURIComponent(taskId)}/claim?playerId=${encodeURIComponent(playerId)}`, request);
    }
    ...
    public static equipCatSkin(playerId: string, catId: string, skinId: string): Promise<ApiEnvelope<CatSkinEquipResponse>> {
        return this.post(`/api/cats/${encodeURIComponent(catId)}/skins/${encodeURIComponent(skinId)}/equip?playerId=${encodeURIComponent(playerId)}`, {});
    }

    public static getCatSkinCatalog(playerId: string, catId: string): Promise<ApiEnvelope<CatSkinCatalogItemDto[]>> {
        return this.get(`/api/cats/${encodeURIComponent(catId)}/skins/catalog?playerId=${encodeURIComponent(playerId)}`);
    }
