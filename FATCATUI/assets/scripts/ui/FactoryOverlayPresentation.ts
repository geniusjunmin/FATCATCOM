export function getDomFactoryStyles(factoryCutawayDataUri: string): string {
    return `
            ...
            #fatcat-dom-factory .launch.exhausted { filter:grayscale(.62) brightness(.72); cursor:default; box-shadow:0 5px 0 rgba(55,38,28,.48), inset 0 0 0 3px rgba(255,242,178,.14); }
            ...
            #fatcat-dom-factory .factory-msg { position: absolute; z-index:25; left: 33%; top: 79%; width: 40%; min-height: 3.8%; padding:.3em .55em; box-sizing:border-box; border-radius: 999px; background: rgba(52,35,24,.94); color: #ffe6b5; display:block; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; text-align:center; line-height:1.55; font-size: 1.55%; font-weight: 900; box-shadow: 0 2px 0 rgba(0,0,0,.3); }
