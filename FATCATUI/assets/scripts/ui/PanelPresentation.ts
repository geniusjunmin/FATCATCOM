export const DOM_PANEL_STYLES = `
            ...
            #fatcat-dom-panel-overlay .settings-shell .server-status-card { display:grid; gap:8px; background:linear-gradient(135deg,#6d4a33,#3d291f); color:#ffe5ad; border-color:#9a6b3d; }
            #fatcat-dom-panel-overlay .settings-shell .server-status-card.ready { box-shadow:0 0 0 3px rgba(112,177,74,.18), inset 0 0 0 2px rgba(255,234,178,.12), 0 3px 0 rgba(72,43,25,.22); }
            #fatcat-dom-panel-overlay .settings-shell .server-status-card.offline { opacity:.9; }
            #fatcat-dom-panel-overlay .settings-shell .server-status-head { display:flex; justify-content:space-between; align-items:center; gap:8px; }
            #fatcat-dom-panel-overlay .settings-shell .server-status-head em { padding:3px 10px; border-radius:999px; font-style:normal; font-weight:900; color:#fff; background:linear-gradient(#6eb651,#3b7d31); box-shadow:inset 0 0 0 2px rgba(255,255,255,.16); }
            #fatcat-dom-panel-overlay .settings-shell .server-status-grid { display:grid; grid-template-columns:repeat(4,1fr); gap:6px; }
            #fatcat-dom-panel-overlay .settings-shell .server-status-grid span { min-height:44px; padding:6px; border-radius:9px; background:rgba(36,25,19,.48); color:#e8c88d; font-size:1.75%; font-weight:800; overflow:hidden; }
            #fatcat-dom-panel-overlay .settings-shell .server-status-grid b { display:block; color:#fff7d8; font-size:1.85%; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
            ...
            #fatcat-dom-panel-overlay .social-card-head { display:flex; justify-content:space-between; align-items:center; gap:8px; min-width:0; margin-bottom:8px; font-weight:900; }
            #fatcat-dom-panel-overlay .social-card-head b { display:flex; align-items:center; min-width:0; color:inherit; }
            #fatcat-dom-panel-overlay .social-card-head b:before { content:""; flex:0 0 auto; width:11px; height:11px; margin-right:7px; border-radius:50%; background:radial-gradient(circle at 38% 32%,#fff1a2 0 18%,transparent 20%),linear-gradient(#e4b64e,#9f6424); box-shadow:0 0 0 2px rgba(255,232,169,.2),0 2px 0 rgba(65,38,20,.22); }
            #fatcat-dom-panel-overlay .social-card-head span { min-width:0; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; font-size:88%; font-weight:900; }
            #fatcat-dom-panel-overlay .friend-list { margin-bottom:2%; }
            #fatcat-dom-panel-overlay .friend-list-head { margin:0 1% 2%; color:#ffe5ad; }
            #fatcat-dom-panel-overlay .friend-list-head span { color:#f1c56d; }
            ...
            #fatcat-dom-panel-overlay .social-card-empty { display:inline-block; max-width:72%; color:#f4d49a; font-weight:800; line-height:1.35; }
            #fatcat-dom-panel-overlay .leaderboard-card > .tag { float:right; margin-top:-1%; }
            ...
            #fatcat-dom-panel-overlay .friend-search-card .social-card-head span { color:#f1c56d; }
            ...
            #fatcat-dom-panel-overlay .friend-coop-card { display:grid; grid-template-columns:11% 1fr; align-items:center; gap:2%; margin:2.2% 0; padding:2.2%; min-height:112px; max-height:158px; overflow:hidden; box-sizing:border-box; border-radius:12px; border:2px solid #8b653c; background:linear-gradient(135deg,#fff1cf,#d9b783); color:#4b3020; font-size:2.05%; line-height:1.3; box-shadow:0 4px 0 rgba(52,34,22,.25); }
            ...
            #fatcat-dom-panel-overlay .coop-tiers {
                grid-column:1 / 3;
                display:grid;
            ...
            #fatcat-dom-panel-overlay .coop-tier {
                display:grid;
                ...
                padding:6px 7px;
                border-radius:7px;
                background:rgba(255,248,218,.64);
                box-shadow:inset 0 0 0 1px rgba(91,60,34,.18);
            }
            #fatcat-dom-panel-overlay .coop-tier span,
            #fatcat-dom-panel-overlay .coop-tier b { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
            #fatcat-dom-panel-overlay .coop-tier span { font-size:78%; opacity:.76; }
            #fatcat-dom-panel-overlay .coop-tier b { color:#5d3b23; }
            #fatcat-dom-panel-overlay .coop-tier button {
                grid-column:2;
                grid-row:1 / 3;
                min-width:48px;
                min-height:28px;
                border:1px solid #785737;
                border-radius:6px;
                background:#7a5c3f;
                color:#fff2d0;
                font:inherit;
            ...
            #fatcat-dom-panel-overlay .coop-tier button.ready { background:#5d9636; border-color:#386520; cursor:pointer; }
            #fatcat-dom-panel-overlay .coop-tier.claimed { opacity:.64; }
            #fatcat-dom-panel-overlay .friend-boost-history {
                margin:0 0 2.2%;
                padding:2.2%;
                border:2px solid #55773a;
                border-radius:12px;
                background:linear-gradient(135deg,#e9f0c8,#c6d89e);
                color:#334622;
                box-shadow:0 4px 0 rgba(52,66,31,.22),inset 0 0 0 2px rgba(255,255,226,.42);
                font-size:1.92%;
            }
            #fatcat-dom-panel-overlay .boost-history-head {
                display:grid;
                grid-template-columns:1fr auto;
                gap:2%;
                align-items:center;
                padding-bottom:1.6%;
                border-bottom:1px solid rgba(66,91,40,.25);
            }
            #fatcat-dom-panel-overlay .boost-history-head > div b,
            #fatcat-dom-panel-overlay .boost-history-head > div span { display:block; }
            #fatcat-dom-panel-overlay .boost-history-head > div b { font-size:116%; color:#3f5828; }
            #fatcat-dom-panel-overlay .boost-history-head > div span { opacity:.75; margin-top:.4%; }
            #fatcat-dom-panel-overlay .boost-history-head > strong {
                min-width:76px;
                padding:5px 10px;
                border-radius:8px;
                background:#527f35;
            ...
            #fatcat-dom-panel-overlay .boost-history-head small { display:block; font-size:58%; }
            #fatcat-dom-panel-overlay .boost-history-list {
                display:grid;
                grid-template-columns:repeat(2,minmax(0,1fr));
                gap:6px;
                margin-top:1.6%;
            }
            #fatcat-dom-panel-overlay .boost-history-row {
                display:grid;
                ...
                padding:7px;
                border-radius:8px;
                background:rgba(255,252,221,.72);
                box-shadow:inset 0 0 0 1px rgba(72,98,44,.16);
            }
            #fatcat-dom-panel-overlay .boost-history-row.expired { filter:saturate(.5); opacity:.64; }
            #fatcat-dom-panel-overlay .boost-source-avatar {
                width:32px;
                height:32px;
                border-radius:50%;
                display:flex;
                ...
                background:linear-gradient(#87bc55,#4e7d36);
                color:#fff9dd;
                font-weight:900;
                box-shadow:inset 0 0 0 2px rgba(255,255,220,.24);
            }
            #fatcat-dom-panel-overlay .boost-history-row div { min-width:0; }
            #fatcat-dom-panel-overlay .boost-history-row b,
            #fatcat-dom-panel-overlay .boost-history-row em {
                display:block;
                overflow:hidden;
                text-overflow:ellipsis;
                white-space:nowrap;
            }
            #fatcat-dom-panel-overlay .boost-history-row em { font-style:normal; opacity:.7; font-size:80%; }
            #fatcat-dom-panel-overlay .boost-history-row strong { color:#4e8231; font-size:112%; }
            #fatcat-dom-panel-overlay .boost-history-empty { padding:10px 2px 4px; text-align:center; opacity:.72; font-weight:900; }
            ...
            #fatcat-dom-panel-overlay .friend-scene-sign:before { content:""; position:absolute; left:-13%; right:-13%; top:-48%; height:56%; border:2px solid #5c3a24; border-bottom:0; border-radius:12px 12px 3px 3px; background:linear-gradient(#7a5130,#3e2a1c); box-shadow:0 3px 0 rgba(31,21,15,.34), inset 0 0 0 2px rgba(255,229,164,.12); }
            #fatcat-dom-panel-overlay .friend-scene-sign:after { content:""; position:absolute; left:18%; right:18%; top:-1px; height:8px; border-radius:0 0 5px 5px; background:linear-gradient(90deg,#4e3322 0 11px,transparent 11px calc(100% - 11px),#4e3322 calc(100% - 11px)); pointer-events:none; }
            ...
            #fatcat-dom-panel-overlay .friend-scene-floor b:after { content:""; display:block; width:78%; height:5px; margin:3px 0 1px; border-radius:999px; background:linear-gradient(90deg,#7daa44,#f1c257); box-shadow:0 0 5px rgba(241,194,87,.38), inset 0 0 0 1px rgba(80,49,27,.12); opacity:.92; }
            ...
            #fatcat-dom-panel-overlay .friend-scene-actions .tag:nth-child(2) { background:linear-gradient(#ffca55,#d97822); border-color:#8b4c1d; color:#fff8dc; text-shadow:0 2px #8c4618; box-shadow:0 3px 0 rgba(52,31,18,.34), inset 0 0 0 2px rgba(255,239,190,.26); }
            #fatcat-dom-panel-overlay .friend-scene-actions .tag:first-child,
            #fatcat-dom-panel-overlay .friend-scene-actions .tag:last-child { background:linear-gradient(#735039,#4b3325); color:#ffe5b1; }
            ...
            #fatcat-dom-panel-overlay.compact .friend-coop-card { grid-template-columns:12% 1fr; padding:1.8%; margin:1.6% 0; min-height:106px; max-height:150px; }
            #fatcat-dom-panel-overlay.compact .coop-tiers { gap:3px; }
            #fatcat-dom-panel-overlay.compact .coop-tier { grid-template-columns:1fr; padding:4px; text-align:center; }
            #fatcat-dom-panel-overlay.compact .coop-tier button { grid-column:1; grid-row:auto; width:100%; min-width:0; min-height:24px; }
            #fatcat-dom-panel-overlay.compact .friend-boost-history { padding:1.8%; margin-bottom:1.6%; font-size:1.72%; }
            #fatcat-dom-panel-overlay.compact .boost-history-list { grid-template-columns:1fr; gap:4px; }
            #fatcat-dom-panel-overlay.compact .boost-history-row { min-height:34px; padding:4px 6px; grid-template-columns:28px 1fr auto; }
            #fatcat-dom-panel-overlay.compact .boost-source-avatar { width:28px; height:28px; }
            ...
            #fatcat-dom-panel-overlay.compact .friend-scene-floor b:after { height:3px; margin:1px 0; }
            ...
            #fatcat-dom-panel-overlay .building-panel-tools {
                display:flex;
                align-items:center;
                ...
                padding:1% 1.4% 1% 3%;
                border-radius:10px;
                background:rgba(69,43,27,.74);
                color:#ffe2aa;
                font-size:1.75%;
                font-weight:900;
                box-shadow:inset 0 0 0 2px rgba(255,226,169,.12);
            }
            #fatcat-dom-panel-overlay .building-panel-tools button {
                min-height:31px;
                padding:1% 4%;
                border:1px solid #704421;
                border-radius:8px;
                background:linear-gradient(#f6c968,#d57925);
                color:#fff8dc;
                font:inherit;
                font-weight:900;
                cursor:pointer;
                pointer-events:auto;
                box-shadow:0 2px 0 #7f451d,inset 0 1px 0 rgba(255,255,255,.25);
            }
            ...
            #fatcat-dom-panel-overlay .factory-appearance-shell {
                ...
                background:
                    repeating-linear-gradient(135deg,rgba(88,57,34,.026) 0 2px,transparent 2px 8px),
                    linear-gradient(#ead3a8,#b38457 70%,#644531);
            }
            #fatcat-dom-panel-overlay .factory-appearance-toolbar {
                display:grid;
                grid-template-columns:9% 1fr 20%;
                align-items:center;
                gap:2%;
                margin-bottom:1.4%;
                padding:1.3% 2%;
                border-radius:12px;
                background:linear-gradient(#fff1d1,#d8ad74);
                border:2px solid #765033;
                color:#51321f;
                font-size:1.8%;
                box-shadow:inset 0 0 0 2px rgba(255,250,224,.38),0 3px 0 rgba(63,37,21,.24);
            }
            #fatcat-dom-panel-overlay .factory-appearance-toolbar > button {
                ...
                border-radius:9px;
                background:linear-gradient(#8b6848,#533725);
                color:#fff0c8;
                font:inherit;
                font-size:180%;
                font-weight:900;
            ...
            #fatcat-dom-panel-overlay .factory-appearance-toolbar > span {
                display:flex;
                min-width:0;
                flex-direction:column;
            }
            #fatcat-dom-panel-overlay .factory-appearance-toolbar > span b { font-size:145%; }
            #fatcat-dom-panel-overlay .factory-appearance-toolbar > span small {
                overflow:hidden;
                color:#7b593b;
                text-overflow:ellipsis;
                white-space:nowrap;
            }
            #fatcat-dom-panel-overlay .factory-appearance-toolbar > em {
                padding:5% 4%;
                border-radius:999px;
                background:#66462f;
                color:#ffe5b3;
            ...
            #fatcat-dom-panel-overlay .factory-appearance-stage {
                ...
                background-size:cover;
                overflow:hidden;
                box-shadow:inset 0 0 0 3px rgba(255,239,200,.22),0 4px 0 rgba(56,34,21,.3);
            }
            #fatcat-dom-panel-overlay .factory-appearance-stage.portrait {
                background-size:contain;
            }
            #fatcat-dom-panel-overlay .factory-appearance-stage:after {
                content:"";
                position:absolute;
                inset:auto 0 0;
                height:32%;
                background:linear-gradient(transparent,rgba(37,24,17,.76));
            }
            #fatcat-dom-panel-overlay .factory-appearance-stage > span {
                position:absolute;
                z-index:1;
                left:3%;
                bottom:4%;
                ...
                font-size:2.8%;
                font-weight:900;
                text-shadow:0 2px #3d271b;
            }
            #fatcat-dom-panel-overlay .factory-appearance-stage > span small {
                display:block;
                font-size:58%;
            }
            ...
            #fatcat-dom-panel-overlay .factory-appearance-card {
                ...
                min-height:112px;
                padding:3% 3% 4%;
                border:2px solid #735037;
                border-radius:10px;
                background:linear-gradient(#fff0cf,#d5aa70);
                color:#54341f;
                font:inherit;
                font-size:1.52%;
                cursor:pointer;
                pointer-events:auto;
                box-shadow:inset 0 0 0 2px rgba(255,250,224,.35),0 3px 0 rgba(65,39,23,.25);
            }
            #fatcat-dom-panel-overlay .factory-appearance-card.selected {
                border-color:#e38a29;
                box-shadow:inset 0 0 0 3px #ffe59d,0 3px 0 #934f1c;
            }
            #fatcat-dom-panel-overlay .factory-appearance-card.locked {
                filter:saturate(.62);
            }
            #fatcat-dom-panel-overlay .factory-appearance-card.locked:after {
                content:"锁";
                position:absolute;
                right:7%;
                top:7%;
            ...
            #fatcat-dom-panel-overlay .factory-appearance-thumb {
                ...
                background-repeat:no-repeat;
                background-size:cover;
                box-shadow:inset 0 0 0 2px rgba(78,49,29,.28);
            }
            #fatcat-dom-panel-overlay .factory-appearance-thumb.portrait { background-size:contain; }
            #fatcat-dom-panel-overlay .factory-appearance-card b,
            #fatcat-dom-panel-overlay .factory-appearance-card small {
                display:block;
                overflow:hidden;
                text-overflow:ellipsis;
                white-space:nowrap;
            ...
            #fatcat-dom-panel-overlay .factory-appearance-card.active small {
                color:#4f842e;
                font-weight:900;
            }
            #fatcat-dom-panel-overlay .factory-appearance-bonuses {
                ...
                border:2px solid #735037;
                border-radius:12px;
                background:linear-gradient(#fff2d3,#dbb37b);
                color:#54341f;
                box-shadow:inset 0 0 0 2px rgba(255,250,224,.36),0 3px 0 rgba(65,39,23,.25);
                font-size:1.66%;
            }
            #fatcat-dom-panel-overlay .factory-appearance-bonuses > div:first-child {
                display:flex;
                align-items:center;
                justify-content:space-between;
                gap:3%;
            }
            #fatcat-dom-panel-overlay .factory-appearance-bonuses > div:first-child small { color:#866242; }
            #fatcat-dom-panel-overlay .factory-appearance-bonus-grid {
                display:grid;
                grid-template-columns:repeat(4,minmax(0,1fr));
                gap:1%;
                margin-top:1.2%;
            }
            #fatcat-dom-panel-overlay .factory-appearance-bonus-grid > span {
                display:grid;
                ...
                padding:4%;
                border-radius:8px;
                background:rgba(255,248,221,.58);
                box-shadow:inset 0 0 0 1px rgba(102,66,37,.15);
            }
            #fatcat-dom-panel-overlay .factory-appearance-bonus-grid i {
                grid-row:1 / 3;
                width:100%;
                font-style:normal;
            }
            #fatcat-dom-panel-overlay .factory-appearance-bonus-grid .css-icon { width:78%; }
            #fatcat-dom-panel-overlay .factory-appearance-bonus-grid small {
                overflow:hidden;
                color:#795737;
                text-overflow:ellipsis;
                white-space:nowrap;
            }
            #fatcat-dom-panel-overlay .factory-appearance-bonus-grid b { color:#558331; }
            #fatcat-dom-panel-overlay .factory-appearance-summary {
                display:grid;
                grid-template-columns:1fr auto;
                align-items:center;
                gap:3%;
                ...
                padding:2.2%;
                border-radius:8px;
                background:rgba(255,248,221,.48);
                color:#65452d;
                box-shadow:inset 0 0 0 1px rgba(102,66,37,.12);
            }
            #fatcat-dom-panel-overlay .factory-appearance-summary > span {
                display:flex;
                min-width:0;
                flex-direction:column;
            }
            #fatcat-dom-panel-overlay .factory-appearance-summary small {
                display:-webkit-box;
                overflow:hidden;
                margin-top:2px;
                color:#80603f;
            ...
            #fatcat-dom-panel-overlay .factory-appearance-summary em {
                padding:5px 8px;
                border-radius:7px;
                background:rgba(108,75,45,.12);
                font-style:normal;
                white-space:nowrap;
            }
            #fatcat-dom-panel-overlay .factory-appearance-summary strong { color:#568533; }
            #fatcat-dom-panel-overlay .factory-appearance-apply {
                ...
                border-radius:9px;
                background:linear-gradient(#86b94e,#4e842f);
                color:#fff9df;
                font:inherit;
                font-size:120%;
                font-weight:900;
                cursor:pointer;
                pointer-events:auto;
                box-shadow:0 3px 0 #31521d,inset 0 1px 0 rgba(255,255,255,.24);
            }
            #fatcat-dom-panel-overlay .factory-appearance-apply.active,
            #fatcat-dom-panel-overlay .factory-appearance-apply.locked {
                border-color:#695344;
                background:linear-gradient(#8c7660,#66503e);
                box-shadow:0 3px 0 #49372b;
                cursor:default;
            }
            ...
            #fatcat-dom-panel-overlay.compact .settings-shell .server-status-grid { grid-template-columns:repeat(2,1fr); }
            ...
            #fatcat-dom-panel-overlay.compact .factory-appearance-toolbar {
                grid-template-columns:10% 1fr 21%;
                font-size:1.62%;
            }
            #fatcat-dom-panel-overlay.compact .factory-appearance-stage { min-height:210px; }
            ...
            #fatcat-dom-panel-overlay.compact .factory-appearance-apply {
                min-height:35px;
                margin-top:1%;
            }
            ...
            @media (max-width:390px) {
                ...
                #fatcat-dom-panel-overlay.compact .factory-appearance-toolbar > span small { display:none; }
                #fatcat-dom-panel-overlay.compact .factory-appearance-stage { min-height:188px; }
                #fatcat-dom-panel-overlay.compact .factory-appearance-card {
                    min-height:78px;
                    padding:2% 2% 3%;
                    font-size:1.28%;
                }
                #fatcat-dom-panel-overlay.compact .factory-appearance-card.locked:after {
                    width:18px;
                    height:18px;
                }
                #fatcat-dom-panel-overlay.compact .factory-appearance-bonuses > div:first-child small { display:none; }
                #fatcat-dom-panel-overlay.compact .factory-appearance-bonuses { min-height:126px; }
                #fatcat-dom-panel-overlay.compact .factory-appearance-summary {
                    padding-top:2%;
                    font-size:96%;
                }
                #fatcat-dom-panel-overlay.compact .factory-appearance-bonus-grid > span {
                    padding:3%;
                    grid-template-columns:22% 1fr;
                }
