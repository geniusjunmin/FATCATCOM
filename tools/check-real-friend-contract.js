...
assertContains("friend profile metadata delegation", bottomNav, "renderFriendProfileMeta(this.getFriendProfileMetaView");
assertContains("friend profile metadata renderer", cooperationCards, "export function renderFriendProfileMeta");
assertContains("real friend profile badge", cooperationCards, "真人好友");
assertContains("friend profile refresh action", friendFactoryCards, "data-action=\"refreshFriendProfile\"");
