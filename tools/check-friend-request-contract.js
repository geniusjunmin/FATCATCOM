...
assertContains("friend panel request adapter", bottomNav, "renderFriendRequestPreview");
assertContains("friend panel request delegation", bottomNav, "renderFriendRequestCard({");
...
assertContains("friend panel search adapter", bottomNav, "private renderFriendSearchCard");
assertContains("friend panel search delegation", bottomNav, "return renderFriendSearchCard({");
assertContains("friend panel request card", socialCards, "renderFriendRequestCard");
assertContains("friend panel search card", socialCards, "renderFriendSearchCard");
assertContains("friend panel search input", socialCards, "data-field=\"friendSearch\"");
assertContains("friend panel inline send marker", socialCards, "sendFriendRequestInline");
assertContains("friend panel accept marker", socialCards, "acceptFriendRequest");
assertContains("friend panel reject marker", socialCards, "rejectFriendRequest");
