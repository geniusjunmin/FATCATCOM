...
requireText("goal card delegation", bottomNav, "renderFriendCoopGoalCard({");
requireText("goal card renderer", cooperationCards, "export function renderFriendCoopGoalCard");
requireText("legacy final claim button", cooperationCards, "claimFriendCoopGoal");
requireText("tier claim buttons", cooperationCards, "claimFriendCoopTier");
