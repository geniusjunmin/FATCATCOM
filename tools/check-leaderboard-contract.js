...
assertContains("friend panel leaderboard adapter", bottomNav, "renderLeaderboardPreview");
assertContains("friend panel leaderboard delegation", bottomNav, "renderFriendLeaderboardCard({");
assertContains("friend panel leaderboard renderer", socialCards, "export function renderFriendLeaderboardCard");
assertContains("friend panel leaderboard row", socialCards, 'class="leaderboard-row');
