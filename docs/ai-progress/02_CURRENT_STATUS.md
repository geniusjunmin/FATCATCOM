...
- Main factory DOM layer now includes extra building depth, brick/grid shading, room foreground props, floor level medals, wall-detail layers, denser room lighting, extra worker-cat silhouettes, a more target-like HUD with raised player badge/resource pills, thicker side feature buttons, and thicker bottom operation/navigation buttons.
