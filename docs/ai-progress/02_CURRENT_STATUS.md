...
- Main factory DOM layer now includes extra building depth, brick/grid shading, larger scene-specific room foreground machines/props, floor level medals, wall-detail layers, denser room lighting, larger worker-cat staging, richer roof signage/crates/chimney/flag/fat-cat staging, a more target-like HUD with raised player badge/resource pills, thicker side feature buttons, and thicker bottom operation/navigation buttons.
