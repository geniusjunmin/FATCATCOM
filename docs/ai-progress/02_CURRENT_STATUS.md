...
- Latest social UI pass makes the friend panel feel more like a multiplayer game surface: compact three-column stats on phones, first-screen friend factory cards with cat-style avatars, income bars, visit/gift state chips, and dedicated action buttons. The utility regression now asserts friend cards, income bars, action buttons, request/search/leaderboard/activity modules, and clean runtime state.
