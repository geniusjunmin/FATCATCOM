...
| Multiplayer Base | P1 | Prepare the game for connected multi-user play. | Real friend profiles, visits, daily rewards, requests, activity, and leaderboard are wired; next consider presence refresh cadence, decor inventory, or live interaction transport. |
...
- Next move: expand room snapshots with true decor inventory, add live presence refresh/transport, or add generated bitmap friend-room backdrops.
