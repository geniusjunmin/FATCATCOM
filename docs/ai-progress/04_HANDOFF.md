...
- Latest full gate: three-size utility screenshots, three-player boost-history regression, dual-player help regression, three-player cooperative-goal regression, 18-step UI click regression, focused TypeScript diagnostics, all config/social/decor contracts, and 81/81 server tests passed.
