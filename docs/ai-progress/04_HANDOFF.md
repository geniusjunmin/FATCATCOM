...
- `tools/check-cat-skin-online-ui.js` proves apron equip, reload persistence, and locked manager preview with no second request. `tools/check-cat-skin-sync-contract.js` is part of quick verify; server coverage is 101/101.
...
- Current green evidence: TypeScript diagnostics, four-size cat/main screenshots, 24 floor routes, 18 UI click steps, online skin reload persistence, full quick verify, and 101/101 server tests.
