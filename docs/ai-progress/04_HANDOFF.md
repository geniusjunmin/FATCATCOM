...
- The next social-server step should polish friend request visuals, notification surfacing, and invite/search UX beyond the current prompt-confirm flow.
