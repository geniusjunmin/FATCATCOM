...
- Latest full gate: four-size decor-shop screenshots, feature-panel screenshots, 18-step UI click regression, focused TypeScript diagnostics, all config/social/decor-shop/decor-collection contract checks, and 80/80 server tests passed.
